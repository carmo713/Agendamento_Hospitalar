<!-- filepath: /home/carmo/Documentos/trabalhofinal_agendamentohospitalar/agendamento/resources/views/admin/patients/create.blade.php -->
<x-app-layout>
    <x-slot name="header">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <x-text-input id="health_insurance" class="block mt-1 w-full" type="text" name="health_insurance" :value="old('health_insurance')" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="health_insurance_number" class="block mt-1 w-full" type="text" name="health_insurance_number" :value="old('health_insurance_number')" />
